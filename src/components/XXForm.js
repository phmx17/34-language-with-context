// this is the class based version using 'static contextType = ....'
...
class Form extends Component {
  ...
  render() { 
    const { classes } = this.props  // these are jss styles; imported above 
    const { currentLanguage, setLanguage } = this.context;
